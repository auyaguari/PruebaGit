...
import velo.uned.velocimetro.ActividadPrincipal;
...
public class GpsServices extends Service implements LocationListener, GpsStatus.Listener {
    ...
    public void updateNotification(boolean asData){
        ...
        if(asData){
            builder.setContentText(String.format(getString(R.string.notification), data.getVelocidadMaxima(), data.getDistance()));
        }else{
